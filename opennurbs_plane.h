...
public:
  ...
  */
  ON_Plane(
    const MnjPoint<double>& origin,
    const MnjVector& normal
    );
  ...
  */
  ON_Plane(
    const MnjPoint<double>& origin,
    const MnjVector& x_dir,
    const MnjVector& y_dir
    );
  ...
  */
  ON_Plane(
    const MnjPoint<double>& origin,
    const MnjPoint<double>& x_point,
    const MnjPoint<double>& y_point
    );
  ...
  */
  bool CreateFromPoints(
    const MnjPoint<double>& origin,
    const MnjPoint<double>& point_on_x,
    const MnjPoint<double>& point_on
    );
  ...
  */
  ...
  Returns:
    Plane origin.
  */
  const MnjPoint<double>& Origin() const;

  /*
  Returns:
    Plane unit x-axis.
  */
  const MnjVector& Xaxis() const;

  /*
  Returns:
    Plane unit y-axis.
  */
  const MnjVector& Yaxis() const;

  /*
  Returns:
    Plane unit normal.
  */
  const MnjVector& Normal() const;
  ...
  */
  void SetOrigin( const MnjPoint<double>& origin );
  ...
  */
  MnjPoint<double> ClosestPointTo( 
         MnjPoint<double> point
         ) const;
  ...
  */
  //mnj do we need it ? bool Morph( const ON_SpaceMorph& morph );
...
int ON_Get3dConvexHull( 
          const ON_SimpleArray<MnjPoint> & points, 
