...
public:
  ...
  Parameters:
    ...
    angle_interval_in_radians - [in] increasing angle interval
       in radians with angle_interval_in_radians.Length() <= 2.0*M_PI.
  */
  ON_Arc(
  ...
  ON_Arc( // arc through 3 3d points
    const MnjPoint&, // point P
    const MnjPoint&, // point Q
    const MnjPoint&  // point R
    );
  ...
  Parameters:
    ...
    angle_interval_in_radians - [in] increasing angle interval in radians
              with angle_interval_in_radians.Length() <= 2.0*M_PI
  Returns:
  ...
  */
  ...
  bool Create( // arc through 3 3d points
    const MnjPoint&, // [IN] point P
    const MnjPoint&, // [IN] point Q
    const MnjPoint&  // [IN] point R
    );
  ...
  bool Create(
    const MnjPoint&,  // [IN] point P
    const MnjVector&, // [IN] arc direction at P
    const MnjPoint&   // [IN] point R
    );
  ...
  //   Checks an arc to make sure it is valid.
	// Detail:
	//	 Radius>0 and 0<AngleRadians()<=2 M_PI
  // Returns:
  ...
  // Returns:
  //   3d bounding box.
  MnjBoundingBox BoundingBox() const;
  ...
  */
  ...
  // Parameters:
  //   angle_in_radians - [in] 0 <= angle_in_radians <= 2.0*M_PI
  //
  ...
  Parameters:
    angle_in_radians - [in] increasing interval with 
                            ...
                            Length of the interval <= 2.0*M_PI.
  Returns:
    true if successful. 
  */
  ...
  MnjPoint StartPoint() const;


  // Returns:
  //   Point at middle of the arc.
  MnjPoint MidPoint() const;

  // Returns:
  //   Point at end of the arc.
  MnjPoint EndPoint() const;
  ...
  Example:
          ...
          ON_Arc arc = ...;
          double nurbs_t = 1.2345; // some number in interval (0,2.0*M_PI).
          double arc_t;
  ...
  Remarks:
    ...
    0.0, 0.5*M_PI, M_PI, 1.5*M_PI, and 2.0*M_PI, the nurbs
  ...
  */
  ...
  Parameters:
    arc_radians_parameter - [in] 0.0 to 2.0*M_PI
    nurbs_parameter - [out]
  Example:

          ON_Arc arc = ...;
          double arc_t = 1.2345; // some number in interval (0,2.0*M_PI).
          double nurbs_t;
